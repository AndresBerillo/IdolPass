        ...
        <div class="eventCardPreviewDark p-3 p-md-4 p-lg-5" style="min-height: 100vh;">
            <div style="" class="row">
                ...
                <div class="col-lg-7 ps-lg-5">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="selectAmmount" style="vertical-align: middle; min-width: 115px;">
                                                <select id="5315" class="form-select"
                                                    style="max-width: 8rem; min-width: 4rem;">
                                                    <option>0</option>
                    ...
                    <div class="row align-items-center mt-0 mt-3">
                        <div class="col-12 d-flex align-items-center justify-content-between"><button
                                class="btn btn-primary" >Adquirir</button>
            ...
            <div class="row mt-2">
                <div class="col d-flex align-items-center">
                    <span class="mb-0 d-flex align-items-center">
                        <svg
                            stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" class="me-2 icon"
            ...
            <div class="row mt-5">
                <div class="col-12" style="white-space: pre-wrap; text-align: justify;"><small class="text-silence"
                        style="font-size: 0.8rem">La carga de productos y textos en el sistema licenciado son de exclusiva responsabilidad del Productor/Organizador. IdolPass no se hace responsable civil o jurídicamente por las declaraciones emitidas por estos en lo relativo a los productos vendidos en su plataforma. El Productor/Organizador es el único y exclusivo responsable de la producción y organización del Evento, en forma oportuna y en conformidad a la ley. <a
